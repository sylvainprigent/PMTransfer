/// \file blSlidingStackedWidget.cpp
/// \brief blSlidingStackedWidget
...
blSlidingStackedWidget::blSlidingStackedWidget(QWidget *parent)
...
blSlidingStackedWidget::~blSlidingStackedWidget(){
}

void blSlidingStackedWidget::setVerticalMode(bool vertical) {
        m_vertical=vertical;
}

void blSlidingStackedWidget::setSpeed(int speed) {
        m_speed = speed;
}

void blSlidingStackedWidget::setAnimation(enum QEasingCurve::Type animationtype) {
        m_animationtype = animationtype;
}

void blSlidingStackedWidget::setWrap(bool wrap) {
        m_wrap=wrap;
}

void blSlidingStackedWidget::slideInNext() {
...
void blSlidingStackedWidget::slideInPrev() {
        int now=currentIndex();
        if (m_wrap||(now>0))
                slideInIdx(now-1);
}

void blSlidingStackedWidget::slideInIdx(int idx, enum t_direction direction) {
...
void blSlidingStackedWidget::slideInWgt(QWidget * newwidget, enum t_direction  direction) {
...
void blSlidingStackedWidget::animationDoneSlot(void) {
